...
public class EmailServiceImpl implements EmailService {
    ...
    public String getForgotPasswordEmailTemplate(String name, String otp) {
        String emailTemplate = "<div style=\"font-family: Helvetica, Arial, sans-serif; min-width:1000px; overflow:auto; line-height:2;\">"
                ...
                + "<p style=\"line-height: 1.6; margin-bottom: 15px;\">Regards,<br />OneStopBank</p>"
    ...
    @Override
    public String getForgotSendPassword(String emailAddress, String newPassword) {
        String emailTemplate = "<div style=\"font-family: Helvetica, Arial, sans-serif; min-width:1000px; overflow:auto; line-height:2;\">"
                + "<div style=\"margin:50px auto; width:70%; padding:20px 0;\">"
                + "<p><img alt=\"\" src=\"https://ckeditor.com/apps/ckfinder/userfiles/files/Vector.png\" style=\"width:150px;\" /></p>"
                + "<h1 style=\"color: #00466a;\">AeroSwift</h1>"
                + "<p style=\"line-height: 1.6; margin-bottom: 15px;\">Hello " + emailAddress + ",</p>"
                + "<p style=\"line-height: 1.6; margin-bottom: 15px;\">Thank you for choosing AeroSwift. Your new password has been generated successfully. Please use it to log in:</p>"
                + "<h2 style=\"background: #00466a; margin: 0 auto; width: max-content; padding: 10px; color: #fff; border-radius: 4px; text-align: center;\">" + newPassword + "</h2>"
                + "<p style=\"line-height: 1.6; margin-bottom: 15px;\">Regards,<br />OneStopBank</p>"
                + "<hr style=\"border: 1px solid #ddd; margin: 20px 0;\" />"
                + "<footer style=\"text-align: center; color: #888; font-size: 0.8em; margin-top: 20px;\">&copy; AeroSwift Team 2024. All rights reserved.</footer>"
                + "</div>"
